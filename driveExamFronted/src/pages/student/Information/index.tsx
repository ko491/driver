...
import { currentUserInfo, updateStudent } from "@/services/ant-design-pro/api";
      ...
      <div style={{ maxWidth: 600, margin: 'auto', padding: 16 }}>
        <Card loading={loading}>
          <Form
            ...
            layout="vertical"
          >
            <Descriptions title="学员信息" bordered column={1}>
              ...
              <Descriptions.Item label="所属教练：" span={2}>
                <Form.Item name="coach" initialValue={userData?.coach} noStyle>
                  <Input disabled />
                </Form.Item>
              </Descriptions.Item>
            </Descriptions>
